...
public interface MaintenanceRecordService {
    ...
    PartUsageResponse addPartToRecord(Long recordId, PartUsageRequest request, Authentication authentication);

    List<PartUsageDetailResponse> getAllPartUsagesForRecord(Long recordId, Authentication authentication);
}
